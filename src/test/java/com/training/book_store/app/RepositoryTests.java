...
public class RepositoryTests {
    ...
    @Test
    void shouldAddBook() {
        bookRepo.save( new Book( "untitled", "no author", LocalDate.parse("2015-02-20"), 14.90 ) );
        flushAndClear();
    ...
    void shouldGetBooksBelongingToStore() {
        ...
        Book b1 = new Book( "untitled", "no author", LocalDate.parse("2015-02-20"), 14.90 );
        Book b2 = new Book( "lean startup", "Eric", LocalDate.parse("2011-09-29"), 14.90 );
        s.addBook( b1 );
        s.addBook( b2 );
        storeRepo.save( s );
        flushAndClear();
